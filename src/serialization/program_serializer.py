...
class ProgramSerializer:
    ...
    def dataframes_to_program(
        ...
        uw_dept = self._convert_pandas_to_native(program_df.iloc[0].get(PROGRAM_COLS.UNDERWRITING_DEPARTMENT))
        ...
        if uw_dept and str(uw_dept).lower() == "aviation":
            for col in boolean_columns:
                ...
                if nulls > 0:
                    raise ValueError(f"Column {col} has {nulls} null/empty values for Aviation program.")
        ...
        def df_to_dicts(df: pd.DataFrame) -> List[Dict[str, Any]]:
            ...
            return [{k: self._convert_pandas_to_native(v) for k, v in r.items()} for r in recs]
    ...
    def program_to_dataframes(self, program: Program) -> Dict[str, pd.DataFrame]:
        ...
        structures_data = {
            "INSPER_ID_PRE": [], "BUSINESS_ID_PRE": [], "TYPE_OF_PARTICIPATION_CD": [],
            "TYPE_OF_INSURED_PERIOD_CD": [], "ACTIVE_FLAG_CD": [], "INSPER_EFFECTIVE_DATE": [],
            "INSPER_EXPIRY_DATE": [], "REPROG_ID_PRE": [], "BUSINESS_TITLE": [],
            "INSPER_LAYER_NO": [], "INSPER_MAIN_CURRENCY_CD": [], "INSPER_UW_YEAR": [],
            "INSPER_CONTRACT_ORDER": [], "INSPER_PREDECESSOR_TITLE": [],
            "INSPER_CONTRACT_FORM_CD_SLAV": [], "INSPER_CONTRACT_LODRA_CD_SLAV": [],
            "INSPER_CONTRACT_COVERAGE_CD_SLAV": [], "INSPER_CLAIM_BASIS_CD": [],
            "INSPER_LODRA_CD_SLAV": [], "INSPER_LOD_TO_RA_DATE_SLAV": [], "INSPER_COMMENT": [],
        }

        conditions_data = {
            "BUSCL_ID_PRE": [], "REPROG_ID_PRE": [], "CED_ID_PRE": [], "BUSINESS_ID_PRE": [],
            "INSPER_ID_PRE": [], "BUSCL_EXCLUDE_CD": [], "BUSCL_ENTITY_NAME_CED": [],
            "POL_RISK_NAME_CED": [], "BUSCL_COUNTRY_CD": [], "BUSCL_COUNTRY": [],
            "BUSCL_REGION": [], "BUSCL_CLASS_OF_BUSINESS_1": [], "BUSCL_CLASS_OF_BUSINESS_2": [],
            "BUSCL_CLASS_OF_BUSINESS_3": [], "BUSCL_LIMIT_CURRENCY_CD": [], "AAD_100": [],
            "LIMIT_100": [], "LIMIT_FLOATER_100": [], "ATTACHMENT_POINT_100": [], "OLW_100": [],
            "LIMIT_AGG_100": [], "CESSION_PCT": [], "RETENTION_PCT": [],
            "SUPI_100": [], "BUSCL_PREMIUM_CURRENCY_CD": [], "BUSCL_PREMIUM_GROSS_NET_CD": [],
            "PREMIUM_RATE_PCT": [], "PREMIUM_DEPOSIT_100": [], "PREMIUM_MIN_100": [],
            "BUSCL_LIABILITY_1_LINE_100": [], "MAX_COVER_PCT": [], "MIN_EXCESS_PCT": [],
            "SIGNED_SHARE_PCT": [], "AVERAGE_LINE_SLAV_CED": [], "PML_DEFAULT_PCT": [],
            "LIMIT_EVENT": [], "NO_OF_REINSTATEMENTS": [], "INCLUDES_HULL": [], "INCLUDES_LIABILITY": [],
        }

        def list_to_excel(v):
            if isinstance(v, list): return MULTI_VALUE_SEPARATOR.join(map(str, v))
            return v
        ...
        for st in program.structures:
            ...
            for c in st.conditions:
                ...
                conditions_data["BUSCL_ID_PRE"].append(buscl_id); buscl_id += 1
                ...
                for col in [
                    "BUSCL_ENTITY_NAME_CED","POL_RISK_NAME_CED","BUSCL_COUNTRY_CD","BUSCL_COUNTRY",
                    "BUSCL_REGION","BUSCL_CLASS_OF_BUSINESS_1","BUSCL_CLASS_OF_BUSINESS_2",
                    "BUSCL_CLASS_OF_BUSINESS_3","BUSCL_LIMIT_CURRENCY_CD",
                ]:
                    conditions_data[col].append(list_to_excel(g(col)))

                for col in [
                    "AAD_100","LIMIT_100","LIMIT_FLOATER_100","OLW_100","LIMIT_AGG_100",
                    "RETENTION_PCT","SUPI_100","BUSCL_PREMIUM_CURRENCY_CD","BUSCL_PREMIUM_GROSS_NET_CD",
                    "PREMIUM_RATE_PCT","PREMIUM_DEPOSIT_100","PREMIUM_MIN_100",
                    "BUSCL_LIABILITY_1_LINE_100","MAX_COVER_PCT","MIN_EXCESS_PCT",
                    "SIGNED_SHARE_PCT","AVERAGE_LINE_SLAV_CED","PML_DEFAULT_PCT",
                    "LIMIT_EVENT","NO_OF_REINSTATEMENTS","INCLUDES_HULL","INCLUDES_LIABILITY",
