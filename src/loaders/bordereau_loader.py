...
class BordereauLoader:
    def __init__(self, source: Union[str, Path], data_source: str = "file", source_type: str = "auto", line_of_business: Optional[str] = None, validate: bool = True):
...
def load_bordereau(source: Union[str, Path], data_source: str = "file", source_type: str = "auto", line_of_business: Optional[str] = None) -> pd.DataFrame:
