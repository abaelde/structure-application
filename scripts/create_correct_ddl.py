...
CREATE TABLE EXCLUSIONS (
  ...
  BUSCL_REGION                   STRING,
  PRODICT_TYPE_LEVEL_1           STRING,
  PRODICT_TYPE_LEVEL_2           STRING,
  PRODICT_TYPE_LEVEL_3           STRING,
  ENTITY_NAME_CED                STRING,
  RISK_NAME                      STRING,
  BUSCL_LIMIT_CURRENCY_CD        VARCHAR,
  FOREIGN KEY (RP_ID) REFERENCES PROGRAMS(REINSURANCE_PROGRAM_ID)
);
"""
