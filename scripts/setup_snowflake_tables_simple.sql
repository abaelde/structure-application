-- Script simplifié pour créer les tables Snowflake
...
CREATE INDEX IF NOT EXISTS IDX_PROGRAMS_TITLE ON SNOWFLAKE_LEARNING_DB.MYSCHEMA.PROGRAMS (REPROG_TITLE);
CREATE INDEX IF NOT EXISTS IDX_STRUCTURES_PROGRAM ON SNOWFLAKE_LEARNING_DB.MYSCHEMA.STRUCTURES (PROGRAM_ID);
CREATE INDEX IF NOT EXISTS IDX_CONDITIONS_PROGRAM ON SNOWFLAKE_LEARNING_DB.MYSCHEMA.CONDITIONS (PROGRAM_ID);
CREATE INDEX IF NOT EXISTS IDX_EXCLUSIONS_PROGRAM ON SNOWFLAKE_LEARNING_DB.MYSCHEMA.EXCLUSIONS (PROGRAM_ID);
CREATE INDEX IF NOT EXISTS IDX_RUNS_PROGRAM ON SNOWFLAKE_LEARNING_DB.MYSCHEMA.RUNS (PROGRAM_ID);
CREATE INDEX IF NOT EXISTS IDX_POLICIES_RUN ON SNOWFLAKE_LEARNING_DB.MYSCHEMA.RUN_POLICIES (RUN_ID);
CREATE INDEX IF NOT EXISTS IDX_STRUCTURES_POLICY ON SNOWFLAKE_LEARNING_DB.MYSCHEMA.RUN_POLICY_STRUCTURES (POLICY_RUN_ID);
