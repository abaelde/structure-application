...
def test_exclusion_mechanism():
    ...
    print("=" * 80)
    print(bordereau_df[['policy_id', 'INSURED_NAME', 'BUSCL_COUNTRY_CD', 'BUSCL_REGION', 'exposition']])
    print()
    ...
    print(f"Taux de cession global: {(total_cession/total_effective*100) if total_effective > 0 else 0:.2f}%")
