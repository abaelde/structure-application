...
def test_risk_attaching_based_on_policy_inception():
    ...
    assert structure_result_b.outcome.matching_details["claim_basis"] == "risk_attaching"
...
def test_loss_occurring_based_on_calculation_date():
    ...
    result_in_period = apply_program(policy, program, calculation_date=calculation_date_in_period)
    ...
    result_out_period = apply_program(policy, program, calculation_date=calculation_date_out_period)
    ...
    assert structure_result_out.outcome.matching_details["claim_basis"] == "loss_occurring"
