...
program_data = {
    ...
    "REPROG_TITLE": ["SINGLE_EXCESS_OF_LOSS_2024"],  # Former program_name
    "CED_ID_PRE": [None],  # TBD
...
structures_data = {
    ...
    "INSPER_CONTRACT_ORDER": [None],  # Deprecated (not used anymore)
    "INSPER_PREDECESSOR_TITLE": [None],  # Entry point structure
...
output_file = output_dir / "single_excess_of_loss.xlsx"
...
print(f"✓ Programme Single Excess of Loss créé: {output_file}")
# =============================================================================
