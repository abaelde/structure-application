...
- **TYPE_OF_PARTICIPATION** : VARCHAR(255), type de participation (quota_share, excess_of_loss) (obligatoire)
...
- **EFFECTIVE_DATE** : DATE, date effective (peut être NULL)
...
- **CLAIMS_BASIS** : VARCHAR(255), base de sinistre (risk_attaching, loss_occurring) (peut être NULL)
